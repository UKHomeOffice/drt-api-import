...
class ManifestPersistenceSpec extends FlatSpec with Matchers with Builder {
  ...
  "A request to insert a VoyageManifest" should "result in a row being inserted for each passenger" in {
    ...
    val expected = Vector(
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("DC", "LHR", "JFK", 123, "BA", schTs, 3, 1, "P", "GBR", "T", 10, "LHR", "N", "GBR", "GBR", "12345", in_transit = false, jsonFile),
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("DC", "LHR", "JFK", 123, "BA", schTs, 3, 1, "I", "GBR", "F", 25, "LHR", "N", "GBR", "GBR", "22331", in_transit = false, jsonFile))
  ...
  "A request to persist a VoyageManifest from a zip file" should "result in entries in the VoyageManifestPassenger & ProcessedJson & ProcessedZip tables" in {
    ...
    val expectedPaxRows = Vector(
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("DC", "LHR", "JFK", 123, "BA", schTs, 3, 1, "P", "GBR", "T", 1, "LHR", "N", "GBR", "GBR", "00001", in_transit = false, jsonFile),
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("DC", "LHR", "JFK", 123, "BA", schTs, 3, 1, "I", "GBR", "F", 2, "LHR", "N", "GBR", "GBR", "00002", in_transit = false, jsonFile))
  ...
  "Persisting 2 manifests for the same flight in the same stream" should "result only in entries from the second manifest" in {
    ...
    val expected = Vector(
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("DC", "LHR", "JFK", 123, "BA", schTs, 3, 1, "P", "FRA", "T", 99, "LHR", "N", "GBR", "GBR", "00003", in_transit = false, jsonFile))
  ...
  "Persisting 2 manifests for the same flight with different event codes" should "result only in all entries being persisted" in {
    ...
    val expected = Vector(
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("DC", "LHR", "JFK", 123, "BA", schTs, 3, 1, "P", "GBR", "T", 1, "LHR", "N", "GBR", "GBR", "00001", in_transit = false, jsonFile),
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("DC", "LHR", "JFK", 123, "BA", schTs, 3, 1, "I", "GBR", "F", 2, "LHR", "N", "GBR", "GBR", "00002", in_transit = false, jsonFile),
      InMemoryDatabase.tables.VoyageManifestPassengerInfoRow("CI", "LHR", "JFK", 123, "BA", schTs, 3, 1, "P", "FRA", "T", 99, "LHR", "N", "GBR", "GBR", "00003", in_transit = false, jsonFile))
